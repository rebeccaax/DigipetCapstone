...
class L1LessonFourTalkView : UIViewController, SFSpeechRecognizerDelegate {
    ...
    @IBAction func buttonPressed(_ sender: UIButton) {
        if isRecording == true {
            ...
            let correct: Bool = (myView.scene as! L1LessonFour).checkAnswer(answer: textField.text!)
            let done: Bool! = (myView.scene as! L1LessonFour).isDone()
            ...
            if (correct && done) {
                ...
                (nextViewController as! MinigameCongrats).minigameName = "L1LessonFour"
