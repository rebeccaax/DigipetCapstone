...
class LevelVC : UIViewController {
    ...
    let lesson5 = Lesson(name: "Basics V", petImg: ["china", "spain", "france"], fileDest: "L1LessonFive", infoVH: "color, red, orange, yellow, green, blue, purple, black, white, brown, pink, gray", infoGD: "game desc dnwse fjswie nvweih dhfwseh jd j jwieuuwa", startDesc: "Learn colors!")!
