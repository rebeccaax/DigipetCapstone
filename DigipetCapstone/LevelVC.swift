...
class LevelVC : UIViewController {
    ...
    let lesson3 = Lesson(name: "Basics III", petImg: ["china", "spain", "france"], fileDest: "L1LessonThree", infoVH: "bread, egg, rice, meat, food, milk, juice, water, fruit, vegetables, dessert", infoGD: "Guess the object based on the silhouette", startDesc: "Review foods and drinks.")!
    ...
    let lesson5 = Lesson(name: "Basics V", petImg: ["china", "spain", "france"], fileDest: "L1LessonFive", infoVH: "color, red, orange, yellow, green, blue, purple, black, white, brown, pink, gray", infoGD: "game desc dnwse fjswie nvweih dhfwseh jd j jwieuuwa", startDesc: "Review color vocabulary.")!
